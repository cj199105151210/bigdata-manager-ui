<template>
  <div class="app-container calendar-list-container">
    ...
    <el-dialog title="分配权限" :visible.sync="dialogPermissionVisible" :close-on-click-modal='false'>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" size="small" @click="updatePermession(roleId, roleCode)">保存</el-button>
